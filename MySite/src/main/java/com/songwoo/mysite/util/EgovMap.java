 ...
 * <p>
 * <b>NOTE</b>: commons Collections 의 ListOrderedMap 을 extends 하고 있으며 Map 의 key
 * 를 입력 시 Camel Case 표기법으로 변경하여 처리하는 Map 의 구현체이다. (iBatis 의 경우 egovMap 으로 결과 조회
 * 시 별도의 alias 없이 DB 칼럼명 그대로 조회하는 것 만으로도 일반적인 VO 의 attribute (camel case) 에 대한
 * resultMap 과 같은 효과를 낼 수 있도록 추가하였음)
 * </p>
 * 
 * @author 실행환경 개발팀 우병훈
 * @since 2009.02.06
